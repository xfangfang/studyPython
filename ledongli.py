...
import sys,json,datetime,time,urllib2,urllib
reload(sys)
...
def main(steps, uid):
    ...
    # req = urllib2.Request(url,data=param)
    req = urllib2.Request(url,data=urllib.urlencode(param),headers = fake_headers )
    # req.add_header(fake_headers)
    # req.a
